...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  var this$1 = new $c_sci_MapLike$ImmutableDefaultKeySet().init___sci_MapLike(namedExpressions);
  var this$2 = $m_sci_List$();
  var cbf = this$2.ReusableCBFInstance$2;
  var names = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$1, cbf));
  var jsx$1 = new $c_Lcalculator_Calculator$$anonfun$1().init___sci_Map(namedExpressions);
  var this$3 = $m_sci_List$();
  var e = $as_sci_List(names.map__F1__scg_CanBuildFrom__O(jsx$1, this$3.ReusableCBFInstance$2));
  var this$4 = $m_sci_List$();
  var bf = this$4.ReusableCBFInstance$2;
  return $as_sc_TraversableOnce($s_sc_IterableLike$class__zip__sc_IterableLike__sc_GenIterable__scg_CanBuildFrom__O(names, e, bf)).toMap__s_Predef$$less$colon$less__sci_Map($m_s_Predef$().singleton$und$less$colon$less$2)
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var a$5 = x7.name$2;
      var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(a$5, references);
      var this$1 = references;
      var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(a$1) {
...
$c_Lcalculator_Calculator$$anonfun$1.prototype.apply__O__O = (function(v1) {
  return this.apply__T__Lcalculator_Signal($as_T(v1))
});
...
$c_Lcalculator_Calculator$$anonfun$1.prototype.apply__T__Lcalculator_Signal = (function(x) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, x$2) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(arg$outer.namedExpressions$1$f.apply__O__O(x$2)).apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, x));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
